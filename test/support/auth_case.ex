defmodule AllowancesWeb.AuthCase do
  use Phoenix.ConnTest

  import Ecto.Changeset
  alias Allowances.{Accounts, Repo}
  ...
  def add_token_conn(conn, user) do
    user_token = Phauxth.Token.sign(AllowancesWeb.Endpoint, user.id)
    conn
  ...
  def gen_key(email) do
    Phauxth.Token.sign(AllowancesWeb.Endpoint, %{"email" => email})
  end
end
